...
<base href="<%=basePath%>">
<meta charset="UTF-8">
<title>Build CRUD Application with edit form in expanded row
	details - jQuery EasyUI Demo</title>
...
<script type="text/javascript"
	src="jquery-easyui-1.4.4/datagrid-detailview.js"></script>
		...
		$('#dg').datagrid(
				{
					...
					onExpandRow : function(index, row) {
						...
						ddv.panel({
							border : false,
							cache : true,
							href : 'admin/getUserDetail?id=' + row.id,
							onLoad : function() {
...
<body>
	...
	<table id="dg" title="My Users" style="width: 700px; height: 250px"
		url="admin/getUserList" toolbar="#toolbar" pagination="true"
